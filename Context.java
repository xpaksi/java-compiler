...
class Context {
  ...
  public void C(int ruleNo) {
    ...
    switch (ruleNo) {
      case 0:
        ...
        break;
      case 1:
        if (printSymbols) symbolHash.print(lexicalLevel);
        break;
      case 2:
      ...
      case 15:
        ...
        if (
          (comparedType != Bucket.INTEGER) && typeStack.peek() != Bucket.INTEGER
        ) {
          System.out.println(
            "Unmatched type at line " + currentLine + ": " + currentStr
          );
      ...
      case 23:
        ...
        break;
      case 24:
        // C24: Insert procedure into symbol table (defer duplicate check to C35 for overloading)
        {
      ...
      case 25:
        ...
        break;
      case 26:
        // C26: Insert function into symbol table (defer duplicate check to C35 for overloading)
        {
      ...
      case 35:
        ...
        if (calleeBucket != null && !paramStack.isEmpty()) {
          ...
          for (Bucket param : parameterList) calleeBucket.addParameter(param);
        ...
        if (!argCountStack.isEmpty()) argCountStack.pop();
        break;
      case 36:
      ...
      case 37:
        ...
        if (identifierKind == Bucket.FUNCTION) {} else {
          switch (symbolHash.find(symbolStack.peek()).getIdKind()) {
            case Bucket.UNDEFINED:
              System.out.println(
                "Variable not fully defined at line " +
  ...
  // Parameter handling helpers are now inlined in C cases
}
