	...
	public void R(int ruleNo) {
		...
		switch (ruleNo) {
			...
			case 42:
				...
				cell = cell + 1;
				break;
			// R43: Instruction to back in the of function
			case 43:
				HMachine.memory[cell] = HMachine.BR;
				cell = cell + 1;
				break;
			...
			case 44:
				...
				int entryAddr = Context.symbolHash.find(Context.currentStr).getCodeAddress();
			...
			case 45:
				HMachine.memory[cell] = HMachine.PUSH;
				HMachine.memory[cell + 1] = HMachine.undefined;
				stackPush(cell + 1, returnAddrStack); // save for backpatching
				cell = cell + 2;
				break;
			case 46:
				HMachine.memory[cell] = HMachine.PUSH;
